...
"""
if old not in s: raise SystemExit('v661 block missing')
s=s.replace(old,new,1).replace("'v6.14.61-ROADTEST-dev'","'v6.14.62-ROADTEST-dev'")
p.write_text(s)
i=Path('index.html'); t=i.read_text().replace('JARVIS Road Test v6.14.61-ROADTEST-20260905T1635JST','JARVIS Road Test v6.14.62-ROADTEST-20260905T1740JST'); i.write_text(t)
